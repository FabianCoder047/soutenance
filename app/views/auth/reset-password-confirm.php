...
<head>
    ...
    <title>Nouveau mot de passe | e-Media Support</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="container d-flex justify-content-center">
    <div class="card login-card p-4 p-md-5">
        <div class="text-center mb-4">
            <h3 class="fw-bold text-dark mb-1">Nouveau mot de passe</h3>
            ...
            <form action="/reset-password/confirm" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control border-start-0 bg-light" id="password" name="password" required placeholder="Min. 8 caractères, 1 maj + 1 chiffre">
                    </div>
                </div>

                <div class="mb-4">
                    <label for="password_confirm" class="form-label fw-semibold text-muted">Confirmer le mot de passe</label>
                    <div class="input-group">
                        <span class="input-group-text bg-light border-end-0"><i class="bi bi-lock-fill text-muted"></i></span>
                        <input type="password" class="form-control border-start-0 bg-light" id="password_confirm" name="password_confirm" required placeholder="Re-saisir le mot de passe">
                    </div>
                </div>

                <div class="d-grid mb-3">
                    <button type="submit" class="btn btn-primary">Valider le mot de passe</button>
                </div>
            </form>
        <?php endif; ?>
    </div>
