...
$user = Auth::user();
$initials = strtoupper(substr($user['company_name'] ?? 'C', 0, 2));
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title><?= Helper::escape($title ?? 'Client') ?> | e-Media Support</title>
...
<body class="role-client">
    ...
    <aside class="sidebar" id="sidebarMenu">
        ...
        <nav class="sidebar-nav">
            <a href="/client/dashboard" class="nav-link <?= $currentUri === '/client/dashboard' ? 'active' : '' ?>">
                <i class="bi bi-grid-1x2-fill"></i> Tableau de bord
            </a>
            <a href="/client/projects" class="nav-link <?= $currentUri === '/client/projects' ? 'active' : '' ?>">
                <i class="bi bi-folder-fill"></i> Mes Projets
            </a>
            <a href="/client/tasklists" class="nav-link <?= $currentUri === '/client/tasklists' ? 'active' : '' ?>">
                <i class="bi bi-check2-square"></i> Mes Tasklists
            </a>
            <a href="/client/wishlists" class="nav-link <?= $currentUri === '/client/wishlists' ? 'active' : '' ?>">
                <i class="bi bi-magic"></i> Mes Demandes (Wishlist)
            </a>
            <a href="/client/profile" class="nav-link <?= $currentUri === '/client/profile' ? 'active' : '' ?>">
        ...
        <header class="top-navbar">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="text-end d-none d-sm-block">
                    <h6 class="m-0 fw-bold"><?= Helper::escape($user['company_name'] ?? '') ?></h6>
