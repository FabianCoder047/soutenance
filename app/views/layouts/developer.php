...
$user = Auth::user();
$initials = strtoupper(substr($user['first_name'] ?? 'D', 0, 1) . substr($user['last_name'] ?? 'V', 0, 1));
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body class="role-developer">
    ...
    <aside class="sidebar" id="sidebarMenu">
        ...
        <nav class="sidebar-nav">
            <a href="/developer/dashboard" class="nav-link <?= $currentUri === '/developer/dashboard' ? 'active' : '' ?>">
                <i class="bi bi-grid-1x2-fill"></i> Tableau de bord
            </a>
            <a href="/developer/my-projects" class="nav-link <?= $currentUri === '/developer/my-projects' ? 'active' : '' ?>">
                <i class="bi bi-folder-fill"></i> Mes Projets
            </a>
            <a href="/developer/my-tasklists" class="nav-link <?= $currentUri === '/developer/my-tasklists' ? 'active' : '' ?>">
                <i class="bi bi-check2-square"></i> Mes Tasklists
            </a>
            <a href="/developer/projects" class="nav-link <?= $currentUri === '/developer/projects' ? 'active' : '' ?>">
                <i class="bi bi-eye-fill"></i> Tous les Projets
            </a>
            <a href="/developer/profile" class="nav-link <?= $currentUri === '/developer/profile' ? 'active' : '' ?>">
