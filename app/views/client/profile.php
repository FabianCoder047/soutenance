...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card-premium p-4 p-md-5">
            <h5 class="fw-bold mb-4">Mettre à jour les informations de l'entreprise</h5>
            ...
            <form action="/client/profile" method="POST" class="form-premium">
                ...
                <div class="mb-4">
                    <label for="company_name" class="form-label fw-semibold">Nom de l'entreprise</label>
                    <input type="text" class="form-control" id="company_name" name="company_name" required value="<?= Helper::escape($user['company_name'] ?? '') ?>" placeholder="Ex: e-Media SARL">
                </div>

                <div class="mb-4">
                    <label for="address" class="form-label fw-semibold">Adresse de l'établissement</label>
                    <textarea class="form-control" id="address" name="address" rows="3" required placeholder="Saisissez l'adresse de votre entreprise..."><?= Helper::escape($user['address'] ?? '') ?></textarea>
                </div>
