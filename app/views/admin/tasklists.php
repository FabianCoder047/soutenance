...
<div class="card-premium p-4 mb-4">
    <div class="row align-items-center g-3">
        <div class="col-md-9">
            <form action="/admin/tasklists" method="GET" class="row g-2">
                <div class="col-auto">
                ...
                <div class="col-auto">
                    <select name="assigned_to_id" class="form-select rounded-pill shadow-sm" style="font-size: 0.9rem;">
                ...
                <div class="col-auto">
                    ...
                    <?php if (!empty($filters['project_id']) || !empty($filters['status']) || !empty($filters['assigned_to_id'])): ?>
                        <a href="/admin/tasklists" class="btn btn-outline-secondary rounded-pill px-3 shadow-sm">Réinitialiser</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
